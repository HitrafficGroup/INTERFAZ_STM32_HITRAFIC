...
struct qt_meta_stringdata_connect_dialog_t {
    QByteArrayData data[1];
    char stringdata[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_connect_dialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_connect_dialog_t qt_meta_stringdata_connect_dialog = {
    {
...
const QMetaObject connect_dialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_connect_dialog.data,
      qt_meta_data_connect_dialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_connect_dialog.stringdata))
